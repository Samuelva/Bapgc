 ...
 */
public class AddScreen extends TabPane{
    /**
            ...
            questionPropertyCheckBox.selectedProperty().addListener(new ChangeListener<Boolean>() {
                ...
                public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                    if (newValue) {
                        ...
                        updateAccountAbility.setVisible(true);
                        saveExamBtn.setVisible(true);
                        ...
                        updateAccountAbility.setVisible(false);
                        saveExamBtn.setVisible(false);
